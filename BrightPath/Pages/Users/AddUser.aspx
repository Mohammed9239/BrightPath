<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Shared/Site.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="BrightPath.Pages.Users.AddUser" %>
              ...
              <fieldset>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">كلمة المرور</label>
                        <input type="password" id="input-username" class="form-control form-control-alternative" placeholder="******">
                      </div>
                    </div>

                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">اعادة كلمة المرور</label>
                        <input type="password" id="input-username" class="form-control form-control-alternative" placeholder="******">
                      </div>
                    </div>   
                ...
                <div class="text-center">
                  <input type="submit" name="submit" class="btn btn-primary" value="أضافة" onclick="">
                </div>
